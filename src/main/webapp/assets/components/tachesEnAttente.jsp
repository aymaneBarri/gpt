...
<div id="todo-card" class="col-md mb-4">
	<div class="card tache-list shadow-sm">
		...
		<div class="mb-3 d-flex justify-content-center align-items-center">
			<div class="col-2"><span id="priorite-header" value="<%= listeTachesEnAttente %>">Priorite</span></div>
			<div class="col-4"><span id="titre-header">Titre</span></div>
			<div class="col-4"><span id="delai-header">Delai</span></div>
